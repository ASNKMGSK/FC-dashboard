  ...
  return (
    <div>
      <div className="flex items-end justify-between gap-3 mb-3">
        <div>
          <h2 className="text-lg md:text-xl font-semibold text-sf-brown">활동 로그</h2>
          <p className="text-sm text-sf-brown/60">클라이언트 측 로그(세션 저장)</p>
        </div>
      </div>
      ...
      {activityLog?.length ? (
        ...
        <div className="card text-sm text-sf-brown/70">로그 없음</div>
      )}
    </div>
  );
}
